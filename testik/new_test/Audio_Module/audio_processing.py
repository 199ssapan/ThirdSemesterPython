...
BROWSER_SEARCH = "BROWSER_SEARCH.wav"
OPENING_TEXT_EDITOR = "OPENING_TEXT_EDITOR.wav"
OPENING_EXPLORER = "OPENING_EXPLORER.wav"
FILE_DELETING_SUCCESS = "FILE_DELETING_SUCCESS.wav"
FILE_OPENING = "FILE_OPENING.wav"
